export const PATHS = {
  ...
  CS50X_WEB: {
    ...
    INHERITANCE: '/projects/cs50x-web/inheritance',
    SPELLER: '/projects/cs50x-web/speller',
    DNA: '/projects/cs50x-web/dna',
    TRIVIA: '/projects/cs50x-web/trivia',
    HOMEPAGE: '/projects/cs50x-web/homepage',
    BIRTHDAYS: '/projects/cs50x-web/birthdays',
    BIRTHDAY: '/projects/cs50x-web/birthday',
    FINANCE: '/projects/cs50x-web/finance',
  },
  CS50W: {
    ROOT: '/projects/cs50w',
